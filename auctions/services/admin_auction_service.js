...
async function getAdminAuctionDetail(pool, auctionId, { wsHub } = {}) {
  ...
  auction.sections = {
    ...
    media: {
      ...
      videoId: auction.videoId || null,
      lotTitle: auction.lotTitle,
      independent: !auction.listingId && !auction.videoId,
      videoUrl: auction.videoUrl || auction.mediaVideoHlsUrl || null,
      videoThumbnail:
        auction.videoThumbnail || auction.mediaVideoThumbnailUrl || null,
      cloudflareVideoId: auction.mediaVideoCloudflareId || null,
      images: Array.isArray(auction.mediaImages) ? auction.mediaImages : [],
      description: auction.description || null,
      breed: auction.breed || null,
      gender: auction.gender || null,
      color: auction.color || null,
      ageLabel: auction.ageLabel || null,
    },
